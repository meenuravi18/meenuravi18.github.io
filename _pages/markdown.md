...
>"_To survive this [(2-3 years in)] period, you have to be willing to fail from the moment you wake to the moment your head hits the pillow. You must be willing to fail for days on end, for months on end and maybe even for years on end. The skill you accrete during this trauma is the ability to imagine plausible solutions, and to estimate the likelihood that an approach will work._" ~ https://matt.might.net/articles/successful-phd-students/
...
- [Communicating Science to Nonscientists](https://www.youtube.com/watch?v=IFu3jaLmse0&t=5s)
- [Resources for Students by Fredo Durand](https://people.csail.mit.edu/fredo/student.html)
- "Science is as much an act of persuasion as it is an act of discovery." ~ https://matt.might.net/articles/successful-phd-students/
...
- Find the time of day in which you are most productive e.g., To me, early mornings, when the whole world is quiet, dim, and full of hope, are to be exploited.
- Remove distractions- whether physical or mental
- Present your work in multiple formats: a poster, slide deck, short paper, long-form paper, or talks. Each method of dissemination makes you revisit your process in a new way, revealing new things in your reasoning, sharpening your argument, and identifying gaps- it is a form of repitition.
